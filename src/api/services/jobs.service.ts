...
import { Jobs, JobsFilter } from "../models/jobs.model";

@Injectable({
  providedIn: "root",
})
export class JobsService {
  baseUrl = API_CONSTANTS.SECURE_BASE_URL + "/jobs";

  constructor(private http: HttpClient) { }

  getAll(filterConditions: JobsFilter = {}) {
    let urlQueryParams = "";
  ...
  create(createData: Jobs) {
    return this.http.post(this.baseUrl, createData);
  }

  update(id: number, updateData: Jobs) {
