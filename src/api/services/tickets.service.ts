...
import { Tickets, TicketsFilter } from "../models/tickets.model";

@Injectable({
  providedIn: "root",
})
export class TicketsService {
  baseUrl = API_CONSTANTS.SECURE_BASE_URL + "/tickets";

  constructor(private http: HttpClient) { }

  getAll(filterConditions: TicketsFilter = {}) {
    let urlQueryParams = "";
  ...
  create(createData: Tickets) {
    return this.http.post(this.baseUrl, createData);
  }

  update(id: number, updateData: Tickets) {
