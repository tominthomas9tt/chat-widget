...
import { Whatsapp_templates, Whatsapp_templatesFilter } from "../models/whatsapp_templates.model";

@Injectable({
  providedIn: "root",
})
export class Whatsapp_templatesService {
  baseUrl = API_CONSTANTS.SECURE_BASE_URL + "/whatsapp_templates";

  constructor(private http: HttpClient) { }

  getAll(filterConditions: Whatsapp_templatesFilter = {}) {
    let urlQueryParams = "";
  ...
  create(createData: Whatsapp_templates) {
    return this.http.post(this.baseUrl, createData);
  }

  update(id: number, updateData: Whatsapp_templates) {
