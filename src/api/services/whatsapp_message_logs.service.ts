...
import { Whatsapp_message_logs, Whatsapp_message_logsFilter } from "../models/whatsapp_message_logs.model";

@Injectable({
  providedIn: "root",
})
export class Whatsapp_message_logsService {
  baseUrl = API_CONSTANTS.SECURE_BASE_URL + "/whatsapp_message_logs";

  constructor(private http: HttpClient) { }

  getAll(filterConditions: Whatsapp_message_logsFilter = {}) {
    let urlQueryParams = "";
  ...
  create(createData: Whatsapp_message_logs) {
    return this.http.post(this.baseUrl, createData);
  }

  update(id: number, updateData: Whatsapp_message_logs) {
